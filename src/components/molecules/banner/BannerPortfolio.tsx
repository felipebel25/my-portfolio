    ...
    return (
        <Box id='banner' component='section' sx={styles.main}>
            <Box component='article' sx={styles.sectionText} className='animate__animated animate__fadeInLeft' >
                ...
                <Box>
                    <Button onClick={() => navigateToPublicUrl('https://github.com/felipebel25')} startIcon={<GitHub />} sx={{ ...styles.button, marginLeft: '0px !important' }} variant="outlined">
                        GitHub
                    </Button>
                    <Button onClick={() => navigateToPublicUrl('https://www.linkedin.com/in/felipemedinadev/')} startIcon={<LinkedIn />} sx={styles.button} variant="outlined">
                        Linkedin
                    </Button>
                    <Button   target="_blank" href="/documents/cv_felipe_medina.pdf"  startIcon={<DescriptionOutlined />} sx={styles.button} variant="outlined">
                        Download CV
                    </Button>
                </Box>
            </Box>
